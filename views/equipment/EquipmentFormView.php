...
class EquipmentFormView
{
    public static function render()
    {
        ...
        <?= Layout::header() ?>
        <h2>Sprzęt</h2>
        <form action="./index.php?action=equipment-add" method="post" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <label for="warrantyTo">Gwarancja do:</label>
                    <input type="date" name="warrantyTo" class="form-control"><br>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    <label for="amountNet">Kwota zakupu:</label>
